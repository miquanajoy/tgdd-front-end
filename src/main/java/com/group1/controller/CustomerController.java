...
public class CustomerController {
			...
			else
			{
				...
				for(String it: items) 
				{
					...
					for(ProductAddToCartForm item: itemsAsList) 
					{
						...
						ResponseEntity<CartViewImageAttachment> imageResponse =
						resttemp.getForEntity(getImageAttachmentUrl, CartViewImageAttachment.class);
					
						CartViewImageAttachment finalImage = imageResponse.getBody();
						if(item.getColorID() != null) finalImage.setForColorID(item.getColorID());
	...
	public ModelAndView addProductToCart(ModelAndView model, @ModelAttribute("addCartForm") ProductAddToCartForm addForm, 
	HttpServletRequest request, HttpServletResponse response)
	{
		...
		if(cartItemCookie == null) 
		{
			...
			if(addForm.getColorID() != null) 
			{
				...
				ResponseEntity<String> ColorNameResponse =
				resttemp.getForEntity(getColorNameUrl, String.class);
